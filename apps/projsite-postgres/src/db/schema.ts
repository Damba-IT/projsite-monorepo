...
export const projectStatusEnum = pgEnum('project_status', ['active', 'inactive', 'deleted']);
...
export const organizations = pgTable('organizations', {
  ...
  logo: text('logo'),
  settings: jsonb('settings').$type<{ // TODO:: move to separate table or keep as JSONB in organizations table?
...
export const projects = pgTable('projects', {
  ...
  updated_at: timestamp('updated_at')
    .defaultNow()
    .$onUpdate(() => sql`CURRENT_TIMESTAMP`),
  settings: jsonb('settings').$type<{ // TODO:: move to separate table or keep as JSONB in projects table?
  ...
  form_validation_rules: jsonb('form_validation_rules').$type<{
    shipment_booking: {
      contractor: boolean;
