...
subProjectRouter.get("/", async (c) => {
  try {
    ...
    return c.json({ success: false, error: "Failed to fetch sub-projects" }, 500);
  }
});
...
subProjectRouter.get("/project/:projectId", async (c) => {
  try {
    ...
    return c.json({ success: false, error: "Failed to fetch sub-projects by project" }, 500);
  }
});
...
subProjectRouter.get("/project/:projectId/active", async (c) => {
  try {
    ...
    const subProjects = await subProjectService.findActiveByProjectId(projectId);
    return c.json({ success: true, data: subProjects });
  } catch (error) {
    console.error("Error fetching active sub-projects by project:", error);
    return c.json({ success: false, error: "Failed to fetch active sub-projects by project" }, 500);
  }
});
...
subProjectRouter.get("/:id", async (c) => {
  try {
    ...
    return c.json({ success: false, error: "Failed to fetch sub-project" }, 500);
  }
});
...
subProjectRouter.post("/", async (c) => {
  try {
    ...
    return c.json({ success: false, error: "Failed to create sub-project" }, 500);
  }
});
...
subProjectRouter.put("/:id", async (c) => {
  try {
    ...
    return c.json({ success: false, error: "Failed to update sub-project" }, 500);
  }
});
...
subProjectRouter.patch("/:id/status", async (c) => {
  try {
    ...
    return c.json({ success: false, error: "Failed to update sub-project status" }, 500);
  }
});
...
subProjectRouter.patch("/:id/name", async (c) => {
  try {
    ...
    return c.json({ success: false, error: "Failed to update sub-project name" }, 500);
  }
});
...
subProjectRouter.delete("/:id", async (c) => {
  try {
    ...
    return c.json({ success: true, message: "Sub-project deleted successfully" });
  } catch (error) {
    console.error("Error deleting sub-project:", error);
    return c.json({ success: false, error: "Failed to delete sub-project" }, 500);
  }
});
