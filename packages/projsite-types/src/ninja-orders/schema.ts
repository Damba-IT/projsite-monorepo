...
export const ninjaOrderStatusEnum = z.enum([
  "pending",
  "processing",
  "completed",
  "cancelled",
...
export const ninjaOrderCreatedByServiceEnum = z.enum([
  "web",
  "mobile",
  "public_web",
] as const);
export type NinjaOrderCreatedByService = z.infer<
  typeof ninjaOrderCreatedByServiceEnum
>;
...
export const updateNinjaOrderSchema = createNinjaOrderSchema.partial().extend({
